 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(5,160," UMaT School of Railways And Infrastructure Development");
	glColor3f(1,1,1);
	...
	glColor3f(1,0,1);
	output(40,100,"Edited By :");
	glBegin(GL_LINES);
	glVertex2f(40,98);
	glVertex2f(50,98);
	glEnd();
	glColor3f(1,0,0);
	output(40,90," Kalculus");
	...
	output(40,50,"");
	glColor3f(1,0,0);
	drawstring(72,50,"(Dr. Ezekiel Martey)",GLUT_BITMAP_HELVETICA_18);
	glColor3f(1,0,0);
